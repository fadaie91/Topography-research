...
plt_v = quiver(yv, zv, quiver=interior(V)[1,:,:]', title="deravative", xlabel="y", ylabel="z", color=:black, linewidth=1.5)
savefig(plt_v, "quiver_v_deravative.png")

plt_w = quiver(yv, zv, quiver=interior(W)[1,:,:]', title="W_deravative", xlabel="y", ylabel="z", color=:black, linewidth=1.5)
savefig(plt_w, "quiver_w_deravative.png")
